...
class Index extends BASE_Controller{
    ...
    public function getList(){
        ...
        if($this->is_admin){//管理员
            $data_res = $this->corp_model->get_list($project_name,$review_status,$this->is_admin,$this->expert_info,$offset,$page_size,0,1);
    ...
    public function export_admin(){
        ...
        $titles = array('项目名称','报名人姓名','手机号','报名来源','参赛身份','企业名称','产品类型','产品形态','评审状态','评审情况','平均分');
